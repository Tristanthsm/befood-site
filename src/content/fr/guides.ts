...
export const guidePages: GuidePage[] = [
  {
    ...
    intro:
      "L'analyse d'un repas en photo peut faire gagner du temps, mais elle n'a de valeur que si l'interprétation reste concrète, nuancée et utile au quotidien.",
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "Ce format favorise la régularité: quand la collecte devient plus simple, il devient plus facile d'observer ses habitudes sur plusieurs semaines.",
        ],
      },
      {
      ...
      },
      {
        ...
        bullets: [
          ...
          "3) Obtenir une explication pédagogique, sans langage médical.",
  ...
  },
  {
    ...
    intro:
      "Comprendre ce que l'on mange ne se résume pas à compter. Le but est d'interpréter un repas dans son ensemble et de décider quoi faire ensuite.",
  ...
  },
  {
    ...
    intro:
      "Le calorie tracker peut être utile dans certains contextes. Mais beaucoup d'utilisateurs recherchent une alternative plus pédagogique et moins contraignante.",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "BeFood n'essaie pas d'être un compteur de calories de plus. Le produit privilégie la lecture du repas, la guidance et la progression dans le temps.",
        ],
      },
    ],
    relatedSlugs: [
  ...
  },
  {
    ...
    title: "Coach nutrition IA : comment BeFood aide à interpréter vos repas",
    description:
      "Ce qu'un coach nutrition IA peut apporter concrètement: interprétation des repas, guidance contextualisée et suivi des habitudes.",
    intro:
      "Un coach nutrition IA est utile s'il éclaire les décisions réelles. Il ne remplace pas un professionnel de santé et ne délivre pas de diagnostic.",
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "BeFood associe analyse photo, interprétation contextualisée, dimension sociale et parcours coach/pro pour soutenir des habitudes durables.",
        ],
      },
    ],
    relatedSlugs: [
