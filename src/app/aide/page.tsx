...
export const metadata: Metadata = createPageMetadata({
  title: "Aide application nutrition",
  description: "Aide BeFood: questions sur le compte, l'abonnement iOS, les analyses repas et la confidentialité.",
  path: "/aide",
  keywords: ["aide BeFood", "support application nutrition", "assistance abonnement App Store"],
});
